...
# GRIPPER_JOINT = 'left_ee_joint'

GROUP_NAME_ARM = 'arm_right'
GROUP_NAME_GRIPPER = 'right_gripper'
GRIPPER_FRAME = 'right_ee_link'
GRIPPER_JOINT = 'right_ee_joint'
ARM_INIT_POSE = 'right_arm_startpose'
...
class MoveItPickAndPlaceDemo:
    def __init__(self):
        ...
        place_pose.pose.position.z = self.table_ground + target_size[2] / 2.0 + 0.1
    ...
    def make_grasps(self, initial_pose_stamped, allowed_touch_objects):
        ...
        g.pre_grasp_approach = self.make_gripper_translation(0.02, 0.05, self.direction_z)
